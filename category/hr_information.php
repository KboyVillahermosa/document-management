...
$category = 'HR Information Systems (HRIS)';
...
<body>
    ...
    <section class="header-sec p-4 sm:ml-64">
        <div class="recruite-header">
            ...
            <h1 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-4xl dark:text-white uppercase">Recruitment and Staffing Files</h1>
                <ul class="file-list">
